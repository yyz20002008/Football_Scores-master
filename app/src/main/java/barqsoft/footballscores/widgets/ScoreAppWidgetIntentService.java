...
/**
 * Created by James Yang on 12/3/2015.
 */
public class ScoreAppWidgetIntentService extends IntentService implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public ScoreAppWidgetIntentService() {
        super("ScoreAppWidgetIntentService");
    }
